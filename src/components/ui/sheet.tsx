  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed inset-y-0 right-0 z-50 flex w-full max-w-xl flex-col bg-background shadow-xl ring-1 ring-foreground/10 outline-none",
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex shrink-0 items-start justify-between border-b px-5 py-4", className)}
      {...props}
    />
  )
}
