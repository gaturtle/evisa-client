...
export function VisaProcessingsPage() {
  ...
  function openEdit(visaProcessing: VisaProcessing) {
    setEditTarget(visaProcessing)
    setFormOpen(true)
  }
    ...
    <div className="flex flex-col flex-1 min-h-0 px-8 py-6">
      ...
      <div className="flex items-center justify-between gap-3 mb-4 shrink-0">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Search processing options..."
            value={search}
      ...
      <TableContainer className="shrink-0">
          <Table className="min-w-max table-fixed text-sm [&_tr]:border-border/40">
            ...
            <TableBody>
              ...
              {!isLoading &&
                !isError &&
                filtered.map((visaProcessing, index) => (
                  <TableRow
                    key={visaProcessing.id}
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              ...
                              onClick={() => setDeleteTarget(visaProcessing)}
                            >
      ...
      <VisaProcessingFormDialog
        open={formOpen}
        onOpenChange={setFormOpen}
        visaProcessing={editTarget}
      />

      <DeleteVisaProcessingDialog
        open={!!deleteTarget}
